...
import {
  ...
  userDeleteAction,
  userUnBlockedAction,
} from "../../features/Admin/asyncActions";
import { getAllBlogsAction } from "../../features/Blogs/asyncActions";
...
const index = () => {
  ...
  const userBlockHandler = async (id) => {
    await dispatch(userBlockedAction(id));
    await dispatch(getAllUsersAction());
  };

  const userUnBlockHandler = async (id) => {
    console.log(id);
    await dispatch(userUnBlockedAction(id));
    await dispatch(getAllUsersAction());
  };
  useEffect(() => {
  ...
  return (
    <div>
      <div class="flex h-screen">
        <div class="px-4 py-2  bg-gray-800 lg:w-1/4">
          <svg
        ...
        <div class="w-full px-4 py-2 bg-gray-200 lg:w-full">
          <div class="container mx-auto mt-12">
            ...
            <div
              class="flex flex-col mt-8 h-full"
              style={{
                height: "76vh",
              }}
            >
              <div class="py-2 -my-2  sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 overflow overflow-y-scroll">
                        ...
                        <tr>
                            ...
                            <svg
                              onClick={async () => {
                                const { value: fruit } = await Swal.fire({
                                  ...
                                  inputPlaceholder: "Select a proccess",
                                  ...
                                  inputValidator: (value) => {
                                    ...
                                    if (value === "userBlock") {
                                      ...
                                      userBlockHandler(user._id);
                                    }
                                    if (value === "userUnBlock") {
                                      userUnBlockHandler(user._id);
                                    }
                                  },
                                });
                              }}
                          ...
                          <td class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                            <svg
                              onClick={() => {
                                Swal.fire({
                                  title: "Hesabı Silmek İstiyor Musunuz?",
